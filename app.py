...
# Load S&P 500 stocks dynamically
sp500_tickers = ["AAPL", "MSFT", "GOOGL", "AMZN", "TSLA", "BBY", "NFLX", "NVDA", "META", "JPM"]
stock_data = [get_stock_info(symbol) for symbol in sp500_tickers]
